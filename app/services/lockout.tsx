...
export default function LockoutServiceScreen() {
  ...
  const loadProviders = async () => {
    try {
      await getProviders('lockout', location.latitude, location.longitude);
    } catch (error) {
  ...
  const handleRequestService = async () => {
    ...
    try {
      ...
      await createServiceRequest({
        ...
        notes: 'Need help to unlock my vehicle'
      });
          ...
          <View style={styles.stepContainer}>
            ...
            <Card style={styles.infoCard}>
              <View style={styles.infoHeader}>
                ...
                <Text style={styles.infoTitle}>Lockout Assistance Service</Text>
              </View>
              <Text style={styles.infoText}>
                Our technicians use specialized tools to safely unlock your vehicle without causing damage. 
                This service is for when you're locked out of your vehicle and don't have access to your keys.
              </Text>
        ...
        return (
          <View style={styles.stepContainer}>
            ...
            <Card style={styles.summaryCard}>
              ...
              <View style={styles.summaryItem}>
                ...
                <View style={styles.summaryValueContainer}>
                  <Key size={16} color={colors.secondary} />
                  <Text style={styles.summaryValue}>Lockout Assistance</Text>
                </View>
              </View>
              ...
              <View style={styles.priceBreakdown}>
                ...
                <View style={styles.priceItem}>
                  ...
                  <Text style={styles.priceItemValue}>₹399</Text>
                </View>
                ...
                <View style={styles.totalContainer}>
                  ...
                  <Text style={styles.totalValue}>₹477</Text>
                </View>
              </View>
            ...
            <View style={styles.infoContainer}>
              ...
              <Text style={styles.infoText}>
                You will need to provide proof of ownership before the service is completed.
              </Text>
            </View>
          </View>
        );
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Header title="Lockout Assistance" />
